...
(function () {
    var lastTime = 0; var vendors = ["ms", "moz", "webkit", "o"]; for (var x = 0; x < vendors.length && !window.requestAnimationFrame; ++x) { window.requestAnimationFrame = window[vendors[x] + "RequestAnimationFrame"]; window.cancelAnimationFrame = window[vendors[x] + "CancelAnimationFrame"] || window[vendors[x] + "CancelRequestAnimationFrame"] } if (!window.requestAnimationFrame) window.requestAnimationFrame = function (callback, element) {
        var currTime = (new Date).getTime(); var timeToCall = Math.max(0, 16 - (currTime - lastTime)); var id =
            window.setTimeout(function () { callback(currTime + timeToCall) }, timeToCall); lastTime = currTime + timeToCall; return id
    }; if (!window.cancelAnimationFrame) window.cancelAnimationFrame = function (id) { clearTimeout(id) }
})(); window.tcYoutubeApiInitiated = false; window.onYouTubeIframeAPIReady = function () { window.tcYoutubeApiInitiated = true; var event = document.createEvent("HTMLEvents"); event.initEvent("TCYoutubeReady", true, false); window.dispatchEvent(event) };
(function () {
    var h, l = this;
    function m(a) {
    ...
    G.prototype.a = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.currentTarget = b; var f = a.relatedTarget; if (f) { if (A) { var e; a: { try { y(f.nodeName); e = !0; break a } catch (g) { } e = !1 } e || (f = null) } } else "mouseover" == c ? f = a.fromElement : "mouseout" == c && (f = a.toElement); this.relatedTarget = f; null === d ? (this.offsetX = B || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = B || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX,
    ...
    function Ka(a, b) {
        if (a.w) return !0; if (!va) {
            var c; if (!(c = b)) a: { c = ["window", "event"]; for (var d = l, f; f = c.shift();)if (null != d[f]) d = d[f]; else { c = null; break a } c = d } f = c; c = new G(f, this); d = !0; if (!(0 > f.keyCode || void 0 != f.returnValue)) {
                a: { var e = !1; if (0 == f.keyCode) try { f.keyCode = -1; break a } catch (W) { e = !0 } if (e || void 0 == f.returnValue) f.returnValue = !0 } f = []; for (e = c.currentTarget; e; e = e.parentNode)f.push(e); for (var e = a.type, g = f.length - 1; !c.X && 0 <= g; g--) { c.currentTarget = f[g]; var k = La(f[g], e, !0, c), d = d && k } for (g = 0; !c.X && g < f.length; g++)c.currentTarget =
                    f[g], k = La(f[g], e, !1, c), d = d && k
            } return d
    ...
    Z.prototype.h = function () {
        var a = this; this.S && I(this.S, "click", function (b) { b.preventDefault(); a.f(b, "Header: Logo", "link") }); this.T && I(this.T, "click", function (b) { b.preventDefault(); a.f(b, "Header: Sign in", "link") }); this.R && I(this.R, "click", function (b) { b.preventDefault(); a.f(b, "Header: Create your blog", "link") }); this.V && I(this.V, "click", function (b) { b.preventDefault(); a.f(b, "Closing module: Create your blog", "link") }); this.U && I(this.U, "click", function (b) {
            b.preventDefault(); a.f(b, "Language Toggler: Opened",
                "")
        }); this.O && w(this.O, function (b) { I(b, "click", function (c) { c.preventDefault(); var d = "Footer " + ($a && b.dataset ? "track" in b.dataset ? b.dataset.track : null : b.getAttribute("data-" + "track".replace(/([A-Z])/g, "-$1").toLowerCase())); a.f(c, d, "link") }) })
    }; Z.prototype.f = function (a, b, c) { this.Y(b); "link" === c && J(function () { window.location.href = a.currentTarget.href }, 1E3) }; Z.prototype.Y = function (a) { ga("send", "event", a, "Click") }; function mb() { this.ha = this.ma = this.ga = this.oa = this.ra = this.la = null }
